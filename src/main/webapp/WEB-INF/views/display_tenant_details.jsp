...
<body>
 <!-- Sidebar -->
    ...
    <table border="1">
        ...
        <% List<TenantDetails> tenantDetailsList = (List<TenantDetails>)request.getAttribute("tenantDetailsList");
           for (TenantDetails tenantDetails : tenantDetailsList) { %>
            <tr>
                <td><%= tenantDetails.getTenantId() %></td>
                <td><%= tenantDetails.getFullName() %></td>
                <td><%= tenantDetails.getPhone() %></td>
                <td><%= tenantDetails.getEmail() %></td>
                <td><%= tenantDetails.getAddress() %></td>
                <td><%= tenantDetails.getOccupation() %></td>
            </tr>
        <% } %>
    </table>
</body>
